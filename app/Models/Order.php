...
class Order extends Model
{
    ...
    protected $fillable = ['order_number', 'business_location_id', 'user_id', 'customer_name', 'order_type', 'status', 'kitchen_status', 'rejection_reason', 'subtotal', 'tax_total', 'discount_total', 'grand_total', 'payment_method'];
