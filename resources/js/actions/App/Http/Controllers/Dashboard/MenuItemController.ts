 ...
 * @see app/Http/Controllers/Dashboard/MenuItemController.php:66
 * @route '/menu-pos/items/{item}'
 */
 ...
 * @route '/menu-pos/items/{item}'
 */
update.patch = (args: { item: string | { id: string } } | [item: string | { id: string } ] | string | { id: string }, options?: RouteQueryOptions): RouteDefinition<'patch'> => ({
    url: update.url(args, options),
    method: 'patch',
})
 ...
 * @see app/Http/Controllers/Dashboard/MenuItemController.php:121
 * @route '/menu-pos/items/{item}'
 */
...
const MenuItemController = { create, store, show, edit, update, destroy }
