...
import {
  ...
  destroy,
  search,
} from "@/generated/routes/ingredient-categories";
import { Entity } from "@/lib/permissions";
import type { PageProps } from "@/types";

export default function IngredientCategoriesIndex({
  categories,
}: PageProps<{ categories: any[] }>) {
  return (
    <>
          ...
          <XDataTable
            ...
            columns={[
              ...
              },
              {
                ...
                cell: ({ row }) => row.original.parent_category?.name || "-",
              },
              {
                accessorKey: "status",
                header: "Status",
            ...
            entity={Entity.IngredientCategories}
            searchRoute={search}
          />
        </div>
      </div>
